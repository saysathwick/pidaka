...
export const wallSettings = pgTable("wall_settings", {
  ...
  guestLogin: boolean("guest_login").notNull().default(true),
  ...
  safetyCheckOpen: boolean("safety_check_open").notNull().default(false),
  moderationKeywords: text("moderation_keywords").notNull().default("[]"),
  noticeOpen: boolean("notice_open").notNull().default(true),
  noticeTitle: text("notice_title").notNull().default(""),
