...
const TOKEN_KEY = "pidaka_hearth_users";

export function clearHearthUsersToken() {
  localStorage.removeItem(TOKEN_KEY);
}

export async function hearthUsersRequest(method: string, url: string, data?: unknown) {
